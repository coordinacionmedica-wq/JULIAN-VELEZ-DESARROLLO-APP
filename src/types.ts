...
export interface AIEngineSettings {
  ...
  weekendSpacingWeeks: number;
  priorityRuralD1: boolean;
  blockTriplets: boolean; // No more than 3 consecutive shifts of any kind
  enablePostShiftRest: boolean;
  mandatoryFreeWeekends?: number; // per month
  customRules?: string;
}
